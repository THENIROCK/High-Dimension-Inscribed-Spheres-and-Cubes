...
We may graph the volumes of the IK-Sphere, unit $n$-sphere and bounding $n$-cube to visualise how the IK-Sphere expands to fill the space between its surrounding $n$-spheres (see Figure \ref{fig:All volumes comparison}). Again, the dotted lines indicate integer dimensions because fractional dimensions are undefined. 
\begin{figure}[H]
    \centering
    % \begin{tikzpicture}
    %     \begin{axis}[
